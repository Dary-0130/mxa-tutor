...
| TASK-521 | Paper 多文件子线(多文档身份 + 多篇上传融合 + 值冲突检测 + 出处标篇 + 前端) | 🔍 | Codex | 多文件子线;521-A 多文档身份契约 substrate ✅ 合并(#150);521-B1 多篇上传+解析融合 ✅ 合并(#152);521-B2 值冲突检测+冲突展示 ✅ 合并(#154);521-C(出处标到篇·对外)/ 521-D(多选上传+主文献勾选+文件来源展示+部分成功提示)待起草 |
