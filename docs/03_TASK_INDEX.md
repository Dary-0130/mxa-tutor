...
| TASK-521 | Paper 多文件子线(多文档身份 + 多篇上传融合 + 出处标篇 + 前端) | 🔍 | Codex | 多文件子线;521-A 多文档身份契约 substrate ✅ 合并(#150);521-B1 多篇上传+解析融合 ✅ 合并(#152);521-B2(值冲突检测)/ 521-C(出处标到篇·对外)/ 521-D(前端多选+展示)待起草 |
