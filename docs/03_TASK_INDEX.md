...
| TASK-517 | run-state scoped-token 安全门 enforcement(b3-2b / 517-B) | 🔍 | Codex | 本 PR 把 517-A scoped-token 锁装到 `/run-state`;route-wrapper enforcement + MATLAB token seam + OpenAPI/docs 同步;合并后 PM 再翻 ✅ |
